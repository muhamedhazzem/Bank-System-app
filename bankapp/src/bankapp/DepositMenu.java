    ...
    private void depositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositButtonActionPerformed
        ...
        if (amountField.getText().isEmpty()) {
            ...
            try {
                ...
                int result = JOptionPane.showConfirmDialog(this, "Deposit EGP" + String.format("%.2f", amount) + " to the account?\nInterest Earned: EGP" + String.format("%.2f", (customer.getAccount().getInterest() * amount)));
